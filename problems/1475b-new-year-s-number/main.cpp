...
// Problem statement: https://codeforces.com/problemset/problem/1475/B?locale=en
...
int main() {
    ...
    while(test_count--) {
        ...
        unsigned count_2020s = number / 2020u;
        unsigned count_1s = number % 2020u;
        bool representable = count_1s <= count_2020s;
