...
// Problem statement: https://codeforces.com/problemset/problem/1857/A?locale=en
...
int main() {
    ...
    for(auto _ : counted(test_count)) {
        ...
        for(auto _ : counted(array_length)) {
            ...
            if(number % 2 != 0) odd_count++;
        }
        bool can_be_colored = odd_count % 2 == 0;
        std::cout << (can_be_colored ? "YES" : "NO") << std::endl;
    }
}
