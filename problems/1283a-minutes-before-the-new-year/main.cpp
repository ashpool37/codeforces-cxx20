...
// Problem statement: https://codeforces.com/problemset/problem/1283/A?locale=en
...
int main() {
    ...
    while(test_count--) {
        unsigned time_hours = from_cin();
        unsigned time_minutes = from_cin();

        unsigned hours_left = 24u - time_hours - 1u;
        unsigned minutes_left_last_hour = 60u - time_minutes;
        unsigned minutes_left = hours_left * 60u + minutes_left_last_hour;

        std::cout << minutes_left << std::endl;
    }
}
