...
// Problem statement: https://codeforces.com/problemset/problem/1829/B?locale=en
...
int main() {
    ...
    for(auto const _ : counted(test_count)) {
        ...
        unsigned blank_space_length = 0;
        unsigned blank_space_max_length = 0;
        for(auto const _ : counted(array_length)) {
            unsigned const number = from_cin();
            switch(number) {
                case 1:
                    blank_space_length = 0;
                    break;
                case 0:
                    blank_space_length++;
                    blank_space_max_length = std::max(blank_space_length, blank_space_max_length);
                    break;
            }
        }

        std::cout << blank_space_max_length << std::endl;
    }
}
