// Problem: 1996A. Legs
// Problem statement: https://codeforces.com/problemset/problem/1996/A?locale=en
...
int main() {
    ...
    while(test_count--) {
        unsigned leg_count = from_cin();
        unsigned animal_count = leg_count / 4 + (leg_count % 4) / 2;
        std::cout << animal_count << std::endl;
    }
}
