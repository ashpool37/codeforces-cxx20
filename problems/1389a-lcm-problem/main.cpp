...
// Problem statement: https://codeforces.com/problemset/problem/1389/A?locale=en
...
int main() {
    ...
    for(auto const _ : counted(test_count)) {
        ...
        if(upper_bound < lower_bound * 2u) std::cout << "-1 -1" << std::endl;
        else std::cout << lower_bound << " " << lower_bound * 2u << std::endl;
    }
}
