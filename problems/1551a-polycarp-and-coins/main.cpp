...
// Problem statement: https://codeforces.com/problemset/problem/1551/A?locale=en
...
int main() {
    ...
    while(test_count--) {
        unsigned amount_to_pay = from_cin();
        unsigned coins_2b_count = amount_to_pay / 3;
        unsigned coins_1b_count = coins_2b_count;
        switch(amount_to_pay % 3) {
            case 0: break;
            case 1: coins_1b_count++; break;
            case 2: coins_2b_count++; break;
        }
        std::cout << coins_1b_count << " " << coins_2b_count << std::endl;
    }
}
