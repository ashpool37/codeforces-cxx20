...
// Problem statement: https://codeforces.com/problemset/problem/1729/A?locale=en
...
int main() {
    ...
    for(auto const _ : counted(test_count)) {
        int const lift_1_pos = from_cin();
        int const lift_2_pos = from_cin();
        int const lift_2_dest = from_cin();
        int const lift_1_eta = lift_1_pos - 1;
        int const lift_2_eta = std::abs(lift_2_pos - lift_2_dest) + lift_2_dest - 1;
        if(lift_1_eta == lift_2_eta) std::cout << 3 << std::endl;
        else if(lift_1_eta < lift_2_eta) std::cout << 1 << std::endl;
