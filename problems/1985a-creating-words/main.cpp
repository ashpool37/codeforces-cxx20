...
// Problem statement: https://codeforces.com/problemset/problem/1985/A?locale=en
...
int main() {
    ...
    while(test_count--) {
        std::string word1 = word_from_cin();
        std::string word2 = word_from_cin();
        std::swap(word1[0], word2[0]);
